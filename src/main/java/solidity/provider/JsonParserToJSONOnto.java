...
public class JsonParserToJSONOnto {
    ...
    public String JsonContractToJavaObject(String contractInJSON, String contractHash) {
        ...
        if (contractAntlrFormat == null || !contractAntlrFormat.has("sourceUnit")
                || !contractAntlrFormat.get("sourceUnit").isJsonArray()) {
            return "{}";
        }
        String id;
        ...
        for (int i = 0; i < contractArray.size(); i++) {
          try {
            ...
            System.err.println("[JsonParserToJSONOnto] Error processing element " + i + ": " + ex.getMessage());
          }
        }
